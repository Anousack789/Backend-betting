...
@NgModule({
  declarations: [DAgentManagementComponent, DEditBalanceDialogComponent, DAgentDetailComponent, DAgentInformationComponent, DAgentContractComponent, DAgentPlayersComponent],
  imports: [
    CommonModule,
